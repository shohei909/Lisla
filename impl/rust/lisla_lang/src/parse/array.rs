...
impl ArrayContext {
    pub fn new(
        ...
        ArrayContext {
            ...
            kind: ArrayContextKind::Space(SpaceContext::new(space_start, false)),
        }
    }
    ...
    pub fn complete(mut self, input:&EndInput, errors:&mut ErrorWrite<ParseError>) -> ATreeArrayBranch<TemplateLeaf> {
        let footer_space = match self.kind {
            ...
            ArrayContextKind::String(context) => {
                ...
                SpaceContext::new(input.index, false).complete(input)
            }
        };
...
impl ArrayData {
    ...
    fn close_array(
        ...
        ArrayContext {
            kind: ArrayContextKind::Space(SpaceContext::new(input.index, false)),
            data: data,
        }
    }
