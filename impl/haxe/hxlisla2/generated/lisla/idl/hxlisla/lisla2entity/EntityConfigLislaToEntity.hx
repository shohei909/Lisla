...
class EntityConfigArrayTreeToEntity {
    public static function process(context:arraytree.idl.arraytree2entity.ArrayTreeToEntityContext):hxext.ds.Result<arraytree.idl.hxarraytree.entity.EntityConfig, Array<arraytree.idl.arraytree2entity.error.ArrayTreeToEntityError>> return switch (context.arraytree.kind) {
        ...
        case arraytree.data.tree.al.AlTreeKind.Arr(array):{
            {
                ...
                var instance = new arraytree.idl.hxarraytree.entity.EntityConfig(arg0, arg1);
