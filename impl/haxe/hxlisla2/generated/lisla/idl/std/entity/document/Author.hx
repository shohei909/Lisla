...
@:forward abstract Author(lisla.data.meta.core.StringWithMetadata) to lisla.data.meta.core.StringWithMetadata {
    ...
    public static function fromString(string:String, metadata:lisla.data.meta.core.Metadata) {
        return new lisla.idl.std.entity.document.Author(new lisla.data.meta.core.StringWithMetadata(string, metadata));
    }
}