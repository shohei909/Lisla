...
class LixmlChildrenTupleArrayTreeToEntity {
    public static function process(context:arraytree.idl.arraytree2entity.ArrayTreeToEntityContext):hxext.ds.Result<arraytree.idl.std.entity.xml.lixml.LixmlChildrenTuple, Array<arraytree.idl.arraytree2entity.error.ArrayTreeToEntityError>> {
        return switch (context.arraytree.kind) {
            ...
            case arraytree.data.tree.al.AlTreeKind.Arr(array):{
                ...
                var instance = {
                    ...
                    var arg0 = switch (arrayContext.readRest(arraytree.idl.std.arraytree2entity.xml.lixml.LixmlContentArrayTreeToEntity.process, function(data) {
                    ...
                    var instance = new arraytree.idl.std.entity.xml.lixml.LixmlChildrenTuple(arg0);
    ...
    public static function variableInlineProcess(arrayContext:arraytree.idl.arraytree2entity.ArrayTreeToEntityArrayContext):hxext.ds.Result<arraytree.idl.std.entity.xml.lixml.LixmlChildrenTuple, Array<arraytree.idl.arraytree2entity.error.ArrayTreeToEntityError>> return null;
}