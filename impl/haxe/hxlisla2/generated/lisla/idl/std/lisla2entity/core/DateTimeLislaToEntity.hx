...
class DateTimeLislaToEntity {
    public static function process(context:lisla.idl.lisla2entity.LislaToEntityContext):hxext.ds.Result<lisla.idl.std.entity.core.LislaDateTime, Array<lisla.idl.lisla2entity.error.LislaToEntityError>> {
