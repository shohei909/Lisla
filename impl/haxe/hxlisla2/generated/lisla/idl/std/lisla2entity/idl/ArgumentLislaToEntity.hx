...
class ArgumentLislaToEntity {
    public static function process(context:lisla.idl.lisla2entity.LislaToEntityContext):hxext.ds.Result<lisla.idl.std.entity.idl.Argument, Array<lisla.idl.lisla2entity.error.LislaToEntityError>> {
    ...
    public static function variableInlineProcess(arrayContext:lisla.idl.lisla2entity.LislaToEntityArrayContext):hxext.ds.Result<lisla.idl.std.entity.idl.Argument, Array<lisla.idl.lisla2entity.error.LislaToEntityError>> return null;
}