...
class UInt32LislaToEntity {
    public static function process(context:lisla.idl.lisla2entity.LislaToEntityContext):hxext.ds.Result<lisla.idl.std.entity.core.LislaUInt32, Array<lisla.idl.lisla2entity.error.LislaToEntityError>> {
