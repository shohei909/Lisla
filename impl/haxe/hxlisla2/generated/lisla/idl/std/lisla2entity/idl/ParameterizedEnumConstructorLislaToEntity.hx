...
class ParameterizedEnumConstructorArrayTreeToEntity {
    public static function process(context:arraytree.idl.arraytree2entity.ArrayTreeToEntityContext):hxext.ds.Result<arraytree.idl.std.entity.idl.ParameterizedEnumConstructor, Array<arraytree.idl.arraytree2entity.error.ArrayTreeToEntityError>> {
        return switch (context.arraytree.kind) {
            ...
            case arraytree.data.tree.al.AlTreeKind.Arr(array):{
                ...
                var instance = {
                    var arg0 = switch (arrayContext.read(arraytree.idl.std.arraytree2entity.idl.EnumConstructorNameArrayTreeToEntity.process)) {
                    ...
                    var instance = new arraytree.idl.std.entity.idl.ParameterizedEnumConstructor(arg0, arg1);
    ...
    public static function variableInlineProcess(arrayContext:arraytree.idl.arraytree2entity.ArrayTreeToEntityArrayContext):hxext.ds.Result<arraytree.idl.std.entity.idl.ParameterizedEnumConstructor, Array<arraytree.idl.arraytree2entity.error.ArrayTreeToEntityError>> return null;
}