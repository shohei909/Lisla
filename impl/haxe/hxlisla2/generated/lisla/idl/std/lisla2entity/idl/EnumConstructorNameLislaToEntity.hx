...
class EnumConstructorNameLislaToEntity {
    public static function process(context:lisla.idl.lisla2entity.LislaToEntityContext):hxext.ds.Result<lisla.idl.std.entity.idl.EnumConstructorName, Array<lisla.idl.lisla2entity.error.LislaToEntityError>> {
