...
class ArgumentNameArrayTreeToEntity {
    public static function process(context:arraytree.idl.arraytree2entity.ArrayTreeToEntityContext):hxext.ds.Result<arraytree.idl.std.entity.idl.ArgumentName, Array<arraytree.idl.arraytree2entity.error.ArrayTreeToEntityError>> {
        return switch (arraytree.idl.std.arraytree2entity.StringArrayTreeToEntity.process(context)) {
            case hxext.ds.Result.Ok(data):{
                {
                    switch (arraytree.idl.std.entity.idl.ArgumentName.arraytreeToEntity(data)) {
                        case hxext.ds.Result.Ok(data):{
