...
class LicenseLislaToEntity {
    public static function process(context:lisla.idl.lisla2entity.LislaToEntityContext):hxext.ds.Result<lisla.idl.std.entity.document.License, Array<lisla.idl.lisla2entity.error.LislaToEntityError>> {
