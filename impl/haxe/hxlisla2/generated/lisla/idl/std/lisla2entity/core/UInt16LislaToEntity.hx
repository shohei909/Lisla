...
class UInt16LislaToEntity {
    public static function process(context:lisla.idl.lisla2entity.LislaToEntityContext):hxext.ds.Result<lisla.idl.std.entity.core.LislaUInt16, Array<lisla.idl.lisla2entity.error.LislaToEntityError>> {
