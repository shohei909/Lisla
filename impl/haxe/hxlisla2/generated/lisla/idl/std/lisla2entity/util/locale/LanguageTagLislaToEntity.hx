...
class LanguageTagLislaToEntity {
    public static function process(context:lisla.idl.lisla2entity.LislaToEntityContext):hxext.ds.Result<lisla.idl.std.entity.util.locale.LanguageTag, Array<lisla.idl.lisla2entity.error.LislaToEntityError>> {
