...
class ClidlLislaToEntity {
    public static function process(context:lisla.idl.lisla2entity.LislaToEntityContext):hxext.ds.Result<lisla.idl.std.entity.cli.clidl.Clidl, Array<lisla.idl.lisla2entity.error.LislaToEntityError>> return switch (context.lisla.kind) {
        ...
        case lisla.data.tree.al.AlTreeKind.Arr(array):{
            {
                ...
                for (lislaData in array) {
                    ...
                    switch lislaData.kind {
                        ...
                        case lisla.data.tree.al.AlTreeKind.Arr(array) if (array.length == 2 && array[0].kind.match(lisla.data.tree.al.AlTreeKind.Leaf(_ => "about")) && array[1].kind.match(lisla.data.tree.al.AlTreeKind.Leaf(_))):switch (arg1) {
                            case haxe.ds.Option.Some(_):{
                                return hxext.ds.Result.Error(lisla.idl.lisla2entity.error.LislaToEntityError.ofLisla(lislaData, lisla.idl.lisla2entity.error.LislaToEntityErrorKind.StructElementDuplicated("about")));
                            };
                            case haxe.ds.Option.None:{
                        ...
                        case lislaData:return hxext.ds.Result.Error(lisla.idl.lisla2entity.error.LislaToEntityError.ofLisla(lislaData, lisla.idl.lisla2entity.error.LislaToEntityErrorKind.UnmatchedStructElement(["version", "about", "common"])));
                    };
                };
                var instance = new lisla.idl.std.entity.cli.clidl.Clidl(switch (arg0) {
                    ...
                    case haxe.ds.Option.None:{
                        return hxext.ds.Result.Error(lisla.idl.lisla2entity.error.LislaToEntityError.ofLisla(context.lisla, lisla.idl.lisla2entity.error.LislaToEntityErrorKind.StructElementNotFound("about")));
                    };
                });
