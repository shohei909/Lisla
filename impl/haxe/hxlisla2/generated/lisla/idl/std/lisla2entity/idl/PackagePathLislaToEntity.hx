...
class PackagePathLislaToEntity {
    public static function process(context:lisla.idl.lisla2entity.LislaToEntityContext):hxext.ds.Result<lisla.idl.std.entity.idl.PackagePath, Array<lisla.idl.lisla2entity.error.LislaToEntityError>> {
        return switch (lisla.idl.std.lisla2entity.StringLislaToEntity.process(context)) {
            case hxext.ds.Result.Ok(data):{
                {
                    switch (lisla.idl.std.entity.idl.PackagePath.lislaToEntity(data)) {
                        case hxext.ds.Result.Ok(data):{
