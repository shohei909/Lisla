...
class CommandInputArrayTreeToEntity {
    public static function process(context:arraytree.idl.arraytree2entity.ArrayTreeToEntityContext):hxext.ds.Result<arraytree.idl.std.entity.cli.clidl.CommandInput, Array<arraytree.idl.arraytree2entity.error.ArrayTreeToEntityError>> {
        return switch (context.arraytree.kind) {
            ...
            case arraytree.data.tree.al.AlTreeKind.Arr(array):{
                ...
                var instance = {
                    ...
                    var instance = new arraytree.idl.std.entity.cli.clidl.CommandInput();
    ...
    public static function variableInlineProcess(arrayContext:arraytree.idl.arraytree2entity.ArrayTreeToEntityArrayContext):hxext.ds.Result<arraytree.idl.std.entity.cli.clidl.CommandInput, Array<arraytree.idl.arraytree2entity.error.ArrayTreeToEntityError>> return null;
}