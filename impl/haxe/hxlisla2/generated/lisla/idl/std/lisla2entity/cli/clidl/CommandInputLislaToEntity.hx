...
class CommandInputLislaToEntity {
    public static function process(context:lisla.idl.lisla2entity.LislaToEntityContext):hxext.ds.Result<lisla.idl.std.entity.cli.clidl.CommandInput, Array<lisla.idl.lisla2entity.error.LislaToEntityError>> {
        return switch (context.lisla.kind) {
            ...
            case lisla.data.tree.al.AlTreeKind.Arr(array):{
                ...
                var instance = {
                    ...
                    var instance = new lisla.idl.std.entity.cli.clidl.CommandInput();
    ...
    public static function variableInlineProcess(arrayContext:lisla.idl.lisla2entity.LislaToEntityArrayContext):hxext.ds.Result<lisla.idl.std.entity.cli.clidl.CommandInput, Array<lisla.idl.lisla2entity.error.LislaToEntityError>> return null;
}