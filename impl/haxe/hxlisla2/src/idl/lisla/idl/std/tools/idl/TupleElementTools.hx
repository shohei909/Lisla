    ...
    ):Option<GetConditionError>
    {
        ...
        return switch (element)
        {
            case TupleElement.Label(value):
                ...
                condition.conditions.push(ArrayTreeToEntityCaseCondition.Const(value.data));
                Option.None;
            ...
            case TupleElement.Argument(argument):
                switch [argument.name.kind, argument.defaultValue]
                {
                    ...
                    case [ArgumentKind.Rest, Option.Some(_)] 
                        ...
                        Option.Some(argument.name.error(ArgumentSuffixErrorKind.UnsupportedDefault(argument.name.kind)));
                }
        }
    }
}
