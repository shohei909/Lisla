...
class EnumLitllToEntityBuild 
{
    ...
    public function new(builder:LitllToEntityExprBuilder, dataInterface:HaxeDataInterface, parameters:TypeParameterDeclarationCollection, constructors:Array<EnumConstructor>) 
    {
