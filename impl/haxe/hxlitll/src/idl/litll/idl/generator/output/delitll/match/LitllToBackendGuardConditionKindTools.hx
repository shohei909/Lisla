...
class LitllToBackendGuardConditionKindTools 
{
    public static function intersects(kind1:LitllToBackendGuardConditionKind, kind2:LitllToBackendGuardConditionKind):Bool
    {
    ...
    public static function merge(kind1:LitllToBackendGuardConditionKind, kind2:LitllToBackendGuardConditionKind):LitllToBackendGuardConditionKind
    {
        return switch [kind1, kind2]
        {
            case [Always, _]
