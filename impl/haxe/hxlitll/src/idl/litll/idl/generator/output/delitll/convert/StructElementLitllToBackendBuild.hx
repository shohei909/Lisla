...
class StructElementLitllToBackendBuild
{
    private var element:StructElement;
    private var id:String;
    private var parent:StructLitllToBackendBuild;
    
    public inline function new(parent:StructLitllToBackendBuild, element:StructElement, id:String) 
    {
        this.parent = parent;
