...
namespace unifill {
	public class InternalEncodingIter : global::haxe.lang.HxObject {
		
		public InternalEncodingIter(global::haxe.lang.EmptyObject empty) {
		}
		
		
		public InternalEncodingIter(string s, int beginIndex, int endIndex) {
			global::unifill.InternalEncodingIter.__hx_ctor_unifill_InternalEncodingIter(this, s, beginIndex, endIndex);
		}
		
		
		public static void __hx_ctor_unifill_InternalEncodingIter(global::unifill.InternalEncodingIter __hx_this, string s, int beginIndex, int endIndex) {
			__hx_this.i = 0;
			__hx_this.@string = s;
			__hx_this.index = beginIndex;
			__hx_this.endIndex = endIndex;
		}
