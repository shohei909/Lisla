...
@:forward abstract FilePath(lisla.core.LislaString) to lisla.core.LislaString {
    ...
    public static function fromString(string:String, ?tag:hxext.ds.Maybe<lisla.core.tag.StringTag>) {
        return new lisla.idl.std.entity.util.file.FilePath(new lisla.core.LislaString(string, tag));
    }
}