...
@:forward abstract LibraryPath(litll.core.LitllString) to litll.core.LitllString {
    ...
    public static function fromString(string:String, ?tag:hxext.ds.Maybe<litll.core.tag.StringTag>) {
        return new litll.idl.std.entity.idl.LibraryPath(new litll.core.LitllString(string, tag));
    }
}