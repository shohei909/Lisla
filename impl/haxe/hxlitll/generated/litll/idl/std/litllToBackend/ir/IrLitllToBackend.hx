...
class IrLitllToBackend {
    public static function process(context:litll.idl.litllToBackend.LitllToBackendContext):litll.core.ds.Result<litll.idl.std.data.ir.Ir, litll.idl.litllToBackend.LitllToBackendError> return switch context.litll {
        case litll.core.Litll.Arr(array) if (1 <= array.length && array.data[0].match(litll.core.Litll.Str(_.data => "array"))):{
            ...
            var data = {
                ...
                var arg0 = switch (arrayContext.readRest(litll.idl.std.litllToBackend.ir.IrLitllToBackend.process, function(data) {
                        return switch data {
        ...
        case litll.core.Litll.Arr(array) if (array.length == 2 && array.data[0].match(litll.core.Litll.Str(_.data => "option")) && array.data[1].match(litll.core.Litll.Arr(_))):{
            ...
            var data = {
                ...
                var arg0 = switch (arrayContext.read(litll.idl.std.litllToBackend.core.OptionLitllToBackend.process.bind(_, litll.idl.std.litllToBackend.ir.IrLitllToBackend))) {
                    case litll.core.ds.Result.Ok(data):{
                        data;
                    };
                    case litll.core.ds.Result.Err(data):{
        ...
        case litll.core.Litll.Arr(array) if (2 <= array.length && array.data[0].match(litll.core.Litll.Str(_.data => "enum")) && array.data[1].match(litll.core.Litll.Str(_))):{
            ...
            var data = {
                ...
                var arg1 = switch (arrayContext.readRest(litll.idl.std.litllToBackend.ir.IrLitllToBackend.process, function(data) {
                        return switch data {
                            case litll.core.Litll.Arr(array) if (1 <= array.length && array.data[0].match(litll.core.Litll.Str(_.data => "array"))):true;
                            case litll.core.Litll.Arr(array) if (array.length == 2 && array.data[0].match(litll.core.Litll.Str(_.data => "option")) && array.data[1].match(litll.core.Litll.Arr(_))):true;
                            case litll.core.Litll.Arr(array) if (2 <= array.length && array.data[0].match(litll.core.Litll.Str(_.data => "enum")) && array.data[1].match(litll.core.Litll.Str(_))):true;
        ...
        case litll.core.Litll.Arr(array) if (1 <= array.length && array.data[0].match(litll.core.Litll.Str(_.data => "struct"))):{
            ...
            var data = {
                ...
                var arg0 = switch (arrayContext.readFixedInline(litll.idl.std.litllToBackend.core.MapLitllToBackend.fixedInlineProcess.bind(_, StringLitllToBackend, litll.idl.std.litllToBackend.ir.IrLitllToBackend), arrayContext.length - 0)) {
                    case litll.core.ds.Result.Ok(data):{
                        data;
                    };
                    case litll.core.ds.Result.Err(data):{
        ...
        case litll.core.Litll.Arr(array) if (1 <= array.length && array.data[0].match(litll.core.Litll.Str(_.data => "map"))):{
            ...
            var data = {
                ...
                var arg0 = switch (arrayContext.readFixedInline(litll.idl.std.litllToBackend.core.MapLitllToBackend.fixedInlineProcess.bind(_, litll.idl.std.litllToBackend.ir.PrimitiveIrLitllToBackend, litll.idl.std.litllToBackend.ir.IrLitllToBackend), arrayContext.length - 0)) {
                    case litll.core.ds.Result.Ok(data):{
                        data;
                    };
                    case litll.core.ds.Result.Err(data):{
        ...
        case litll.core.Litll.Arr(array) if (array.length == 3 && array.data[0].match(litll.core.Litll.Str(_.data => "fixed_int")) && array.data[1].match(litll.core.Litll.Str(_)) && array.data[2].match(litll.core.Litll.Str(_))):{
            litll.core.ds.Result.Ok(litll.idl.std.data.ir.Ir.Primitive(switch (litll.idl.std.litllToBackend.ir.PrimitiveIrLitllToBackend.process(context)) {
                case litll.core.ds.Result.Ok(data):{
                    data;
                };
                case litll.core.ds.Result.Err(data):{
        ...
        case data:litll.core.ds.Result.Err(litll.idl.litllToBackend.LitllToBackendError.ofLitll(context.litll, litll.idl.litllToBackend.LitllToBackendErrorKind.UnmatchedEnumConstructor(["array", "option", "enum", "tuple", "struct", "map"])));
    };
}