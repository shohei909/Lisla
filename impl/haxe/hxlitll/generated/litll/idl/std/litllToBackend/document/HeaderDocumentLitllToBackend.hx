...
class HeaderDocumentLitllToBackend {
    public static function process(context:litll.idl.litllToBackend.LitllToBackendContext):litll.core.ds.Result<litll.idl.std.data.document.HeaderDocument, litll.idl.litllToBackend.LitllToBackendError> return switch (context.litll) {
                    ...
                    switch litllData {
                        case litll.core.Litll.Arr(array) if (array.length == 2 && array.data[0].match(litll.core.Litll.Str(_.data => "encoding")) && array.data[1].match(litll.core.Litll.Str(_.data => "utf8"))):switch (arg0) {
                            case haxe.ds.Option.Some(_):{
                                return litll.core.ds.Result.Err(litll.idl.litllToBackend.LitllToBackendError.ofLitll(litllData, litll.idl.litllToBackend.LitllToBackendErrorKind.StructElementDuplicated("encoding")));
                            };
                            case haxe.ds.Option.None:{
                                arg0 = haxe.ds.Option.Some({
                                    var context = new litll.idl.litllToBackend.LitllToBackendContext(array.data[1], context.config);
                                    switch (litll.idl.std.litllToBackend.document.DocumentEncodingLitllToBackend.process(context)) {
                        ...
                        case litll.core.Litll.Arr(array) if (array.length == 2 && array.data[0].match(litll.core.Litll.Str(_.data => "license")) && array.data[1].match(litll.core.Litll.Str(_))):arg1.push({
                            var context = new litll.idl.litllToBackend.LitllToBackendContext(array.data[1], context.config);
                            switch (litll.idl.std.litllToBackend.document.LicenseLitllToBackend.process(context)) {
                                case litll.core.ds.Result.Ok(data):{
                                    data;
                                };
                                case litll.core.ds.Result.Err(data):{
                        ...
                        case litll.core.Litll.Arr(array) if (array.length == 2 && array.data[0].match(litll.core.Litll.Str(_.data => "author")) && array.data[1].match(litll.core.Litll.Str(_))):arg2.push({
                            var context = new litll.idl.litllToBackend.LitllToBackendContext(array.data[1], context.config);
                            switch (litll.idl.std.litllToBackend.document.AuthorLitllToBackend.process(context)) {
                                case litll.core.ds.Result.Ok(data):{
                                    data;
                                };
                                case litll.core.ds.Result.Err(data):{
                        ...
                        case litll.core.Litll.Arr(array) if (array.length == 2 && array.data[0].match(litll.core.Litll.Str(_.data => "type"))):switch (arg3) {
                            case haxe.ds.Option.Some(_):{
                                return litll.core.ds.Result.Err(litll.idl.litllToBackend.LitllToBackendError.ofLitll(litllData, litll.idl.litllToBackend.LitllToBackendErrorKind.StructElementDuplicated("type")));
                            };
                            case haxe.ds.Option.None:{
                        ...
                        case litll.core.Litll.Arr(array) if (array.length == 2 && array.data[0].match(litll.core.Litll.Str(_.data => "type_note")) && array.data[1].match(litll.core.Litll.Arr(_))):switch (arg4) {
                            case haxe.ds.Option.Some(_):{
                                return litll.core.ds.Result.Err(litll.idl.litllToBackend.LitllToBackendError.ofLitll(litllData, litll.idl.litllToBackend.LitllToBackendErrorKind.StructElementDuplicated("type_note")));
                            };
                            case haxe.ds.Option.None:{
                                arg4 = haxe.ds.Option.Some({
                                    var context = new litll.idl.litllToBackend.LitllToBackendContext(array.data[1], context.config);
                                    switch (litll.idl.std.litllToBackend.idl.portable.PortableIdlLitllToBackend.process(context)) {
                                        case litll.core.ds.Result.Ok(data):{
                                            data;
                                        };
                                        case litll.core.ds.Result.Err(data):{
                        ...
                        case litll.core.Litll.Arr(array) if (array.length == 2 && array.data[0].match(litll.core.Litll.Str(_.data => "document_markup")) && array.data[1].match(litll.core.Litll.Str(_))):switch (arg5) {
                            case haxe.ds.Option.Some(_):{
                                return litll.core.ds.Result.Err(litll.idl.litllToBackend.LitllToBackendError.ofLitll(litllData, litll.idl.litllToBackend.LitllToBackendErrorKind.StructElementDuplicated("document_markup")));
                            };
                            case haxe.ds.Option.None:{
                                arg5 = haxe.ds.Option.Some({
                                    var context = new litll.idl.litllToBackend.LitllToBackendContext(array.data[1], context.config);
                                    switch (litll.idl.std.litllToBackend.document.DocumentMarkupLanguageLitllToBackend.process(context)) {
                                        case litll.core.ds.Result.Ok(data):{
                                            data;
                                        };
                                        case litll.core.ds.Result.Err(data):{
