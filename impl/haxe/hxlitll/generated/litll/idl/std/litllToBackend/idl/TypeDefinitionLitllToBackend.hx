...
class TypeDefinitionLitllToBackend {
    public static function process(context:litll.idl.litllToBackend.LitllToBackendContext):litll.core.ds.Result<litll.idl.std.data.idl.TypeDefinition, litll.idl.litllToBackend.LitllToBackendError> return switch context.litll {
        case litll.core.Litll.Arr(array) if (array.length == 3 && array.data[0].match(litll.core.Litll.Str(_.data => "newtype"))):{
            ...
            var data = {
                ...
                var arg0 = switch (arrayContext.read(litll.idl.std.litllToBackend.idl.TypeNameDeclarationLitllToBackend.process)) {
        ...
        case litll.core.Litll.Arr(array) if (2 <= array.length && array.data[0].match(litll.core.Litll.Str(_.data => "tuple"))):{
            ...
            var data = {
                ...
                var arg1 = switch (arrayContext.readRest(litll.idl.std.litllToBackend.idl.TupleElementLitllToBackend.process, function(data) {
                        return switch data {
        ...
        case litll.core.Litll.Arr(array) if (2 <= array.length && array.data[0].match(litll.core.Litll.Str(_.data => "enum"))):{
            ...
            var data = {
                ...
                var arg1 = switch (arrayContext.readRest(litll.idl.std.litllToBackend.idl.EnumConstructorLitllToBackend.process, function(data) {
                        return switch data {
                            case litll.core.Litll.Str(_):true;
        ...
        case litll.core.Litll.Arr(array) if (2 <= array.length && array.data[0].match(litll.core.Litll.Str(_.data => "struct"))):{
            ...
            var data = {
                ...
                var arg1 = switch (arrayContext.readRest(litll.idl.std.litllToBackend.idl.StructElementLitllToBackend.process, function(data) {
                        return switch data {
                            case litll.core.Litll.Str(_):true;
        ...
        case data:litll.core.ds.Result.Err(litll.idl.litllToBackend.LitllToBackendError.ofLitll(context.litll, litll.idl.litllToBackend.LitllToBackendErrorKind.UnmatchedEnumConstructor(["newtype", "tuple", "enum", "struct"])));
    };
}