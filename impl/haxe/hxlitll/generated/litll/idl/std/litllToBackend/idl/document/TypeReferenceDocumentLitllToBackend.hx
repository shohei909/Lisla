...
class TypeReferenceDocumentLitllToBackend {
    public static function process(context:litll.idl.litllToBackend.LitllToBackendContext):litll.core.ds.Result<litll.idl.std.data.idl.document.TypeReferenceDocument, litll.idl.litllToBackend.LitllToBackendError> return switch (context.litll) {
