...
class TypeReferenceDocument {
    ...
    public function new(completion:haxe.ds.Option<litll.core.ds.Maybe<litll.core.tag.ArrayTag>>, completionConst:Array<litll.core.Litll>, completionType:Array<litll.idl.std.data.idl.TypeReference>) {
