...
class FileExtensionTupleDelitllfier {
    public static function process(context:litll.idl.delitllfy.DelitllfyContext):litll.core.ds.Result<litll.idl.std.data.idl.library.FileExtensionTuple, litll.idl.delitllfy.DelitllfyError> {
        return switch (context.litll) {
            ...
            case litll.core.Litll.Arr(data):{
                ...
                var instance = {
                    ...
                    var arg0 = switch (arrayContext.read(litll.idl.std.delitllfy.util.file.FileExtensionDelitllfier.process)) {
    ...
    public static function variableInlineProcess(context:litll.idl.delitllfy.DelitllfyArrayContext):litll.core.ds.Result<litll.idl.std.data.idl.library.FileExtensionTuple, litll.idl.delitllfy.DelitllfyError> return null;
}