...
class FileExtensionConfigDelitllfier {
    public static function process(context:litll.idl.delitllfy.DelitllfyContext):litll.core.ds.Result<litll.idl.std.data.idl.config.FileExtensionConfig, litll.idl.delitllfy.DelitllfyError> {
        return switch (context.litll) {
            ...
            case litll.core.Litll.Arr(data):{
                ...
                var instance = {
                    ...
                    var instance = new litll.idl.std.data.idl.config.FileExtensionConfig(arg0, arg1);
