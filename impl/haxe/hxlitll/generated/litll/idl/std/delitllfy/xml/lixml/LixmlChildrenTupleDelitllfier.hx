...
class LixmlChildrenTupleDelitllfier {
    ...
    public static function variableInlineProcess(context:litll.idl.delitllfy.DelitllfyArrayContext):litll.core.ds.Result<litll.idl.std.data.xml.lixml.LixmlChildrenTuple, litll.idl.delitllfy.DelitllfyError> return null;
}