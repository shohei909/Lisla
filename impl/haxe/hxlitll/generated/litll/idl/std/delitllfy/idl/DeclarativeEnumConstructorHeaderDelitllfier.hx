...
class DeclarativeEnumConstructorHeaderDelitllfier {
    public static function process(context:litll.idl.delitllfy.DelitllfyContext):litll.core.ds.Result<litll.idl.std.data.idl.DeclarativeEnumConstructorHeader, litll.idl.delitllfy.DelitllfyError> {
        return switch (context.litll) {
            ...
            case litll.core.Litll.Arr(data):{
                ...
                var data = {
                    ...
                    var arg1 = switch (arrayContext.read(litll.idl.std.delitllfy.idl.EnumConstructorConditionDelitllfier.process)) {
                        case litll.core.ds.Result.Ok(data):{
                            data;
                        };
                        case litll.core.ds.Result.Err(error):{
                    ...
                    var instance = new litll.idl.std.data.idl.DeclarativeEnumConstructorHeader(arg0, arg1);
