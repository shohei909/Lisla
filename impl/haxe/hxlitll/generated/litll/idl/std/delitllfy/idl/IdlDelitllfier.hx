...
class IdlDelitllfier {
    ...
    public static function variableInlineProcess(context:litll.idl.delitllfy.DelitllfyArrayContext):litll.core.ds.Result<litll.idl.std.data.idl.Idl, litll.idl.delitllfy.DelitllfyError> return null;
}