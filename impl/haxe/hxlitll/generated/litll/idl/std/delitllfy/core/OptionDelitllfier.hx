...
class OptionDelitllfier {
    public static function process<T>(context:litll.idl.delitllfy.DelitllfyContext, tDelitllfier):litll.core.ds.Result<litll.idl.std.data.core.LitllOption<T>, litll.idl.delitllfy.DelitllfyError> return switch context.litll {
        ...
        case litll.core.Litll.Arr(array) if (array.length == 1):{
            var arrayContext = new litll.idl.delitllfy.DelitllfyArrayContext(array, 0, context.config);
            var data = {
                var arg0 = switch (arrayContext.read(tDelitllfier.process)) {
