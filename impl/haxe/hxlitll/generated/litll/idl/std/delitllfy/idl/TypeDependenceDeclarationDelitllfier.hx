...
class TypeDependenceDeclarationDelitllfier {
    ...
    public static function variableInlineProcess(context:litll.idl.delitllfy.DelitllfyArrayContext):litll.core.ds.Result<litll.idl.std.data.idl.TypeDependenceDeclaration, litll.idl.delitllfy.DelitllfyError> return null;
}