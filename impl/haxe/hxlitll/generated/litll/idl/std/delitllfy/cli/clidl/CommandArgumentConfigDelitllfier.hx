...
class CommandArgumentConfigDelitllfier {
    public static function process(context:litll.idl.delitllfy.DelitllfyContext):litll.core.ds.Result<litll.idl.std.data.cli.clidl.CommandArgumentConfig, litll.idl.delitllfy.DelitllfyError> return switch (context.litll) {
