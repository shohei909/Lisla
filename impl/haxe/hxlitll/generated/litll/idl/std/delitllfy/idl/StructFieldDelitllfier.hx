...
class StructFieldDelitllfier {
    ...
    public static function variableInlineProcess(context:litll.idl.delitllfy.DelitllfyArrayContext):litll.core.ds.Result<litll.idl.std.data.idl.StructField, litll.idl.delitllfy.DelitllfyError> return null;
}