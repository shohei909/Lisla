...
package litll.idl.std.delitllfy.idl.config;
class IdlConfigDelitllfier {
    public static function process(context:litll.idl.delitllfy.DelitllfyContext):litll.core.ds.Result<litll.idl.std.data.idl.config.IdlConfig, litll.idl.delitllfy.DelitllfyError> return switch (context.litll) {
        ...
        case litll.core.Litll.Arr(array):{
            {
                ...
                for (litllData in array.data) {
                    ...
                    switch litllData {
                        case litll.core.Litll.Arr(array) if (array.length == 2 && array.data[0].match(litll.core.Litll.Str(_.data => "extension")) && array.data[1].match(litll.core.Litll.Arr(_))):switch (arg0) {
                            ...
                            case haxe.ds.Option.None:{
                                arg0 = haxe.ds.Option.Some({
                                    ...
                                    switch (litll.idl.std.delitllfy.idl.config.FileExtensionConfigDelitllfier.process(context)) {
                ...
                var instance = new litll.idl.std.data.idl.config.IdlConfig(switch (arg0) {
