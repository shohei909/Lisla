...
class ImportDeclarationDelitllfier {
    public static function process(context:litll.idl.delitllfy.DelitllfyContext):litll.core.ds.Result<litll.idl.std.data.idl.ImportDeclaration, litll.idl.delitllfy.DelitllfyError> return switch context.litll {
        case litll.core.Litll.Arr(data) if (data.length == 2 && data.data[0].match(litll.core.Litll.Str(_.data => "import"))):{
            ...
            var data = {
                ...
                litll.core.ds.Result.Ok(litll.idl.std.data.idl.ImportDeclaration.Import(arg0));
            };
        ...
        case data:litll.core.ds.Result.Err(litll.idl.delitllfy.DelitllfyError.ofLitll(context.litll, litll.idl.delitllfy.DelitllfyErrorKind.UnmatchedEnumConstructor(["import"])));
    };
}