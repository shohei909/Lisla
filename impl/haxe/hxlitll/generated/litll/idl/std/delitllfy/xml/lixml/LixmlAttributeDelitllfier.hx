...
class LixmlAttributeDelitllfier {
    ...
    public static function fixedInlineProcess(context:litll.idl.delitllfy.DelitllfyArrayContext):litll.core.ds.Result<litll.idl.std.data.xml.lixml.LixmlAttribute, litll.idl.delitllfy.DelitllfyError> return null;
    public static function variableInlineProcess(context:litll.idl.delitllfy.DelitllfyArrayContext):litll.core.ds.Result<litll.idl.std.data.xml.lixml.LixmlAttribute, litll.idl.delitllfy.DelitllfyError> return null;
}