...
class LixmlAttributeDelitllfier {
    ...
    public static function valiableInlineProcess(context:litll.idl.delitllfy.DelitllfyArrayContext):litll.core.ds.Result<litll.idl.std.data.xml.lixml.LixmlAttribute, litll.idl.delitllfy.DelitllfyError> return null;
}