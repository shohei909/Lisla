...
class ParameterizedEnumConstructorLitllToEntity {
    ...
    public static function variableInlineProcess(arrayContext:litll.idl.litll2entity.LitllToEntityArrayContext):hxext.ds.Result<litll.idl.std.data.idl.ParameterizedEnumConstructor, litll.idl.litll2entity.error.LitllToEntityError> return null;
}