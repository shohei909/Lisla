...
class FileOrDirectoryPathLitllToEntity {
    public static function process(context:litll.idl.litll2entity.LitllToEntityContext):litll.core.ds.Result<litll.idl.std.data.util.file.FileOrDirectoryPath, litll.idl.litll2entity.LitllToEntityError> {
