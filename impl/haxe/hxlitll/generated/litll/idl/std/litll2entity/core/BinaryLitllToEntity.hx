...
class BinaryLitllToEntity {
    public static function process(context:litll.idl.litll2entity.LitllToEntityContext):hxext.ds.Result<litll.idl.std.data.core.Binary, litll.idl.litll2entity.error.LitllToEntityError> {
