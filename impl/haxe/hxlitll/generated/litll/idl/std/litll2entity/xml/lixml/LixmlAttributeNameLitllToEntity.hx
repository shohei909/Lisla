...
class LixmlAttributeNameLitllToEntity {
    public static function process(context:litll.idl.litll2entity.LitllToEntityContext):litll.core.ds.Result<litll.idl.std.data.xml.lixml.LixmlAttributeName, litll.idl.litll2entity.LitllToEntityError> {
