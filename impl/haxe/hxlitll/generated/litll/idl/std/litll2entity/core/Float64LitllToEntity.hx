...
class Float64LitllToEntity {
    public static function process(context:litll.idl.litll2entity.LitllToEntityContext):hxext.ds.Result<litll.idl.std.data.core.LitllFloat64, litll.idl.litll2entity.LitllToEntityError> {
