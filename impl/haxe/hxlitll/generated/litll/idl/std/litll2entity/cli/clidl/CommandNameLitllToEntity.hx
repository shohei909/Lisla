...
class CommandNameLitllToEntity {
    public static function process(context:litll.idl.litll2entity.LitllToEntityContext):hxext.ds.Result<litll.idl.std.data.cli.clidl.CommandName, litll.idl.litll2entity.LitllToEntityError> {
