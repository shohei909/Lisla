...
class DateTimeLitllToEntity {
    public static function process(context:litll.idl.litll2entity.LitllToEntityContext):litll.core.ds.Result<litll.idl.std.data.core.LitllDateTime, litll.idl.litll2entity.LitllToEntityError> {
