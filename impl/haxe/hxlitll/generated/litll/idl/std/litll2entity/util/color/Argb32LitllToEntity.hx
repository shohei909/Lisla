...
class Argb32LitllToEntity {
    public static function process(context:litll.idl.litll2entity.LitllToEntityContext):hxext.ds.Result<litll.idl.std.data.util.color.Argb32, litll.idl.litll2entity.error.LitllToEntityError> {
