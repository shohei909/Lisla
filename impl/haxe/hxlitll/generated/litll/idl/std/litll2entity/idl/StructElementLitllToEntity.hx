...
class StructElementLitllToEntity {
    public static function process(context:litll.idl.litll2entity.LitllToEntityContext):hxext.ds.Result<litll.idl.std.entity.idl.StructElement, litll.idl.litll2entity.error.LitllToEntityError> return switch context.litll {
        case litll.core.Litll.Str(_):{
            hxext.ds.Result.Ok(litll.idl.std.entity.idl.StructElement.Label(switch (litll.idl.std.litll2entity.idl.StructElementNameLitllToEntity.process(context)) {
        ...
        case litll.core.Litll.Arr(array) if (array.length == 1 && array.data[0].match(litll.core.Litll.Str(_))):{
            ...
            var data = {
                ...
                hxext.ds.Result.Ok(litll.idl.std.entity.idl.StructElement.NestedLabel(arg0));
            };
        ...
        case litll.core.Litll.Arr(array) if (2 <= array.length && array.length <= 3 && array.data[0].match(litll.core.Litll.Str(_))):{
            hxext.ds.Result.Ok(litll.idl.std.entity.idl.StructElement.Field(switch (litll.idl.std.litll2entity.idl.StructFieldLitllToEntity.process(context)) {
                case hxext.ds.Result.Ok(data):{
                    data;
                };
                case hxext.ds.Result.Err(data):{
