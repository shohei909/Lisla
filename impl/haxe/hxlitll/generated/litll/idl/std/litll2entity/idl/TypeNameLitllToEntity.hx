...
class TypeNameLislaToEntity {
    public static function process(context:lisla.idl.lisla2entity.LislaToEntityContext):hxext.ds.Result<lisla.idl.std.entity.idl.TypeName, lisla.idl.lisla2entity.error.LislaToEntityError> {
