...
class OptionLitllToEntity {
    public static function process<T>(context:litll.idl.litll2entity.LitllToEntityContext, tLitllToEntity):hxext.ds.Result<litll.idl.std.entity.core.LitllOption<T>, litll.idl.litll2entity.error.LitllToEntityError> return switch context.litll {
        case litll.core.Litll.Arr(array) if (array.length == 0):{
            ...
            var data = hxext.ds.Result.Ok(litll.idl.std.entity.core.LitllOption.None);
        ...
        case litll.core.Litll.Arr(array) if (array.length == 1):{
            ...
            var data = {
                ...
                hxext.ds.Result.Ok(litll.idl.std.entity.core.LitllOption.Some(arg0));
            };
            switch (arrayContext.closeOrError()) {
                case haxe.ds.Option.None:{
                    data;
