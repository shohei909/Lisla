...
class AuthorLitllToEntity {
    public static function process(context:litll.idl.litll2entity.LitllToEntityContext):litll.core.ds.Result<litll.idl.std.data.document.Author, litll.idl.litll2entity.LitllToEntityError> {
