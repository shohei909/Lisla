...
class UInt64LitllToEntity {
    public static function process(context:litll.idl.litll2entity.LitllToEntityContext):hxext.ds.Result<litll.idl.std.data.core.LitllUInt64, litll.idl.litll2entity.LitllToEntityError> {
