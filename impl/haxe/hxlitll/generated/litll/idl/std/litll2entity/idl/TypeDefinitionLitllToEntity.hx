...
class TypeDefinitionLitllToEntity {
    public static function process(context:litll.idl.litll2entity.LitllToEntityContext):hxext.ds.Result<litll.idl.std.entity.idl.TypeDefinition, litll.idl.litll2entity.error.LitllToEntityError> return switch context.litll {
        case litll.core.Litll.Arr(array) if (array.length == 3 && array.data[0].match(litll.core.Litll.Str(_.data => "newtype"))):{
            ...
            var data = {
                ...
                hxext.ds.Result.Ok(litll.idl.std.entity.idl.TypeDefinition.Newtype(arg0, arg1));
            };
        ...
        case litll.core.Litll.Arr(array) if (2 <= array.length && array.data[0].match(litll.core.Litll.Str(_.data => "tuple"))):{
            ...
            var data = {
                ...
                hxext.ds.Result.Ok(litll.idl.std.entity.idl.TypeDefinition.Tuple(arg0, arg1));
            };
            switch (arrayContext.closeOrError()) {
                case haxe.ds.Option.None:{
                    data;
        ...
        case litll.core.Litll.Arr(array) if (2 <= array.length && array.data[0].match(litll.core.Litll.Str(_.data => "enum"))):{
            ...
            var data = {
                ...
                hxext.ds.Result.Ok(litll.idl.std.entity.idl.TypeDefinition.Enum(arg0, arg1));
            };
            switch (arrayContext.closeOrError()) {
                case haxe.ds.Option.None:{
                    data;
        ...
        case litll.core.Litll.Arr(array) if (2 <= array.length && array.data[0].match(litll.core.Litll.Str(_.data => "struct"))):{
            ...
            var data = {
                ...
                hxext.ds.Result.Ok(litll.idl.std.entity.idl.TypeDefinition.Struct(arg0, arg1));
            };
            switch (arrayContext.closeOrError()) {
                case haxe.ds.Option.None:{
                    data;
