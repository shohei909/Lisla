...
class PairLitllToEntity {
    public static function process<K, V>(context:litll.idl.litll2entity.LitllToEntityContext, kLitllToEntity, vLitllToEntity):hxext.ds.Result<litll.idl.std.data.core.Pair<K, V>, litll.idl.litll2entity.error.LitllToEntityError> {
