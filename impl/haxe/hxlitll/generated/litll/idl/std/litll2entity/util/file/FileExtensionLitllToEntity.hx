...
class FileExtensionLitllToEntity {
    public static function process(context:litll.idl.litll2entity.LitllToEntityContext):hxext.ds.Result<litll.idl.std.data.util.file.FileExtension, litll.idl.litll2entity.LitllToEntityError> {
