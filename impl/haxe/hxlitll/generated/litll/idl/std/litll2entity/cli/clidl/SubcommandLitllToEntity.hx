...
class SubcommandLitllToEntity {
    ...
    public static function variableInlineProcess(arrayContext:litll.idl.litll2entity.LitllToEntityArrayContext):hxext.ds.Result<litll.idl.std.data.cli.clidl.Subcommand, litll.idl.litll2entity.error.LitllToEntityError> return null;
}