...
class TypeNameDeclarationLitllToEntity {
    public static function process(context:litll.idl.litll2entity.LitllToEntityContext):hxext.ds.Result<litll.idl.std.entity.idl.TypeNameDeclaration, litll.idl.litll2entity.error.LitllToEntityError> return switch context.litll {
        case litll.core.Litll.Str(_):{
            hxext.ds.Result.Ok(litll.idl.std.entity.idl.TypeNameDeclaration.Primitive(switch (litll.idl.std.litll2entity.idl.TypeNameLitllToEntity.process(context)) {
        ...
        case litll.core.Litll.Arr(array) if (1 <= array.length && array.data[0].match(litll.core.Litll.Str(_))):{
            ...
            var data = {
                ...
                hxext.ds.Result.Ok(litll.idl.std.entity.idl.TypeNameDeclaration.Generic(arg0, arg1));
            };
