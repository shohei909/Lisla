...
class TypeNameDeclarationLitllToEntity {
    public static function process(context:litll.idl.litll2entity.LitllToEntityContext):litll.core.ds.Result<litll.idl.std.data.idl.TypeNameDeclaration, litll.idl.litll2entity.LitllToEntityError> return switch context.litll {
        case litll.core.Litll.Str(_):{
            litll.core.ds.Result.Ok(litll.idl.std.data.idl.TypeNameDeclaration.Primitive(switch (litll.idl.std.litll2entity.idl.TypeNameLitllToEntity.process(context)) {
        ...
        case data:litll.core.ds.Result.Err(litll.idl.litll2entity.LitllToEntityError.ofLitll(context.litll, litll.idl.litll2entity.LitllToEntityErrorKind.UnmatchedEnumConstructor(["generic"])));
    };
}