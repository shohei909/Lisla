...
class DocumentLitllToEntity {
    public static function process(context:litll.idl.litll2entity.LitllToEntityContext):hxext.ds.Result<litll.idl.std.data.document.Document, litll.idl.litll2entity.LitllToEntityError> return switch (context.litll) {
        ...
        case litll.core.Litll.Arr(array):{
            {
                    ...
                    switch litllData {
                        case litll.core.Litll.Arr(array) if (array.length == 2 && array.data[0].match(litll.core.Litll.Str(_.data => "comment")) && array.data[1].match(litll.core.Litll.Str(_))):switch (arg0) {
                            case haxe.ds.Option.Some(_):{
                                return hxext.ds.Result.Err(litll.idl.litll2entity.LitllToEntityError.ofLitll(litllData, litll.idl.litll2entity.LitllToEntityErrorKind.StructElementDuplicated("comment")));
                            };
                ...
                var instance = new litll.idl.std.data.document.Document(switch (arg0) {
                    ...
                    case haxe.ds.Option.None:{
                        return hxext.ds.Result.Err(litll.idl.litll2entity.LitllToEntityError.ofLitll(context.litll, litll.idl.litll2entity.LitllToEntityErrorKind.StructElementNotFound("comment")));
                    };
                });
