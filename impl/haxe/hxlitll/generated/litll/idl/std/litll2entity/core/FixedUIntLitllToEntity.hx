...
class FixedUIntLislaToEntity {
    public static function process(context:lisla.idl.lisla2entity.LislaToEntityContext, dependenceBitLength:lisla.idl.std.entity.core.LislaUInt32):hxext.ds.Result<lisla.idl.std.entity.core.FixedUInt, lisla.idl.lisla2entity.error.LislaToEntityError> {
