...
class LibraryConfigLitllToEntity {
    public static function process(context:litll.idl.litll2entity.LitllToEntityContext):hxext.ds.Result<litll.idl.std.entity.idl.library.LibraryConfig, litll.idl.litll2entity.error.LitllToEntityError> return switch (context.litll) {
        ...
        case litll.core.Litll.Arr(array):{
            {
                ...
                switch (litll.idl.std.entity.idl.library.LibraryConfig.litllToEntity(switch (arg0) {
