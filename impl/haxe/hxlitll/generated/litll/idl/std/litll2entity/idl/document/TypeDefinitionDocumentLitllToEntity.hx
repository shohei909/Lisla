...
class TypeDefinitionDocumentLitllToEntity {
    public static function process(context:litll.idl.litll2entity.LitllToEntityContext):litll.core.ds.Result<litll.idl.std.data.idl.document.TypeDefinitionDocument, litll.idl.litll2entity.LitllToEntityError> return switch (context.litll) {
