...
class FixedArrayLitllToEntity {
    public static function process<T>(context:litll.idl.litll2entity.LitllToEntityContext, tLitllToEntity, dependenceLength:litll.idl.std.data.core.LitllInt64):hxext.ds.Result<litll.idl.std.data.core.FixedArray<T>, litll.idl.litll2entity.LitllToEntityError> {
    ...
    public static function fixedInlineProcess<T>(context:litll.idl.litll2entity.LitllToEntityArrayContext, tLitllToEntity, dependenceLength:litll.idl.std.data.core.LitllInt64):hxext.ds.Result<litll.idl.std.data.core.FixedArray<T>, litll.idl.litll2entity.LitllToEntityError> return null;
