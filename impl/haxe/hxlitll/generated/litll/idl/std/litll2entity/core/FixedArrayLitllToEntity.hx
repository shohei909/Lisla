...
class FixedArrayLitllToEntity {
    public static function process<T>(context:litll.idl.litll2entity.LitllToEntityContext, tLitllToEntity, dependenceLength:litll.idl.std.entity.core.LitllInt64):hxext.ds.Result<litll.idl.std.data.core.FixedArray<T>, litll.idl.litll2entity.error.LitllToEntityError> {
