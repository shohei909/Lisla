...
class TypeDependenceNameLitllToEntity {
    public static function process(context:litll.idl.litll2entity.LitllToEntityContext):hxext.ds.Result<litll.idl.std.entity.idl.TypeDependenceName, litll.idl.litll2entity.error.LitllToEntityError> {
        return switch (litll.idl.std.litll2entity.StringLitllToEntity.process(context)) {
            case hxext.ds.Result.Ok(data):{
                {
                    switch (litll.idl.std.entity.idl.TypeDependenceName.litllToEntity(data)) {
                        case hxext.ds.Result.Ok(data):{
