...
class TypeDependenceNameLitllToEntity {
    public static function process(context:litll.idl.litll2entity.LitllToEntityContext):hxext.ds.Result<litll.idl.std.data.idl.TypeDependenceName, litll.idl.litll2entity.error.LitllToEntityError> {
