...
class HeaderDocumentLitllToEntity {
    public static function process(context:litll.idl.litll2entity.LitllToEntityContext):litll.core.ds.Result<litll.idl.std.data.document.HeaderDocument, litll.idl.litll2entity.LitllToEntityError> return switch (context.litll) {
                    ...
                    switch litllData {
                        case litll.core.Litll.Arr(array) if (array.length == 2 && array.data[0].match(litll.core.Litll.Str(_.data => "encoding")) && array.data[1].match(litll.core.Litll.Str(_.data => "utf8"))):switch (arg0) {
                            case haxe.ds.Option.Some(_):{
                                return litll.core.ds.Result.Err(litll.idl.litll2entity.LitllToEntityError.ofLitll(litllData, litll.idl.litll2entity.LitllToEntityErrorKind.StructElementDuplicated("encoding")));
                            };
                        ...
                        case litll.core.Litll.Arr(array) if (array.length == 2 && array.data[0].match(litll.core.Litll.Str(_.data => "type"))):switch (arg3) {
                            case haxe.ds.Option.Some(_):{
                                return litll.core.ds.Result.Err(litll.idl.litll2entity.LitllToEntityError.ofLitll(litllData, litll.idl.litll2entity.LitllToEntityErrorKind.StructElementDuplicated("type")));
                            };
                            case haxe.ds.Option.None:{
                        ...
                        case litll.core.Litll.Arr(array) if (array.length == 2 && array.data[0].match(litll.core.Litll.Str(_.data => "type_note")) && array.data[1].match(litll.core.Litll.Arr(_))):switch (arg4) {
                            case haxe.ds.Option.Some(_):{
                                return litll.core.ds.Result.Err(litll.idl.litll2entity.LitllToEntityError.ofLitll(litllData, litll.idl.litll2entity.LitllToEntityErrorKind.StructElementDuplicated("type_note")));
                            };
                            case haxe.ds.Option.None:{
                        ...
                        case litll.core.Litll.Arr(array) if (array.length == 2 && array.data[0].match(litll.core.Litll.Str(_.data => "document_markup")) && array.data[1].match(litll.core.Litll.Str(_))):switch (arg5) {
                            case haxe.ds.Option.Some(_):{
                                return litll.core.ds.Result.Err(litll.idl.litll2entity.LitllToEntityError.ofLitll(litllData, litll.idl.litll2entity.LitllToEntityErrorKind.StructElementDuplicated("document_markup")));
                            };
                            case haxe.ds.Option.None:{
