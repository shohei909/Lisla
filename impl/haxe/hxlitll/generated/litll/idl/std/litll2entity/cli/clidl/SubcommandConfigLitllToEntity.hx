...
class SubcommandConfigLitllToEntity {
    public static function process(context:litll.idl.litll2entity.LitllToEntityContext):hxext.ds.Result<litll.idl.std.data.cli.clidl.SubcommandConfig, litll.idl.litll2entity.LitllToEntityError> return switch (context.litll) {
