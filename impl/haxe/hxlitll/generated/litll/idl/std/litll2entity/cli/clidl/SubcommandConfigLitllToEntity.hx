...
class SubcommandConfigLitllToEntity {
    public static function process(context:litll.idl.litll2entity.LitllToEntityContext):hxext.ds.Result<litll.idl.std.entity.cli.clidl.SubcommandConfig, litll.idl.litll2entity.error.LitllToEntityError> return switch (context.litll) {
        ...
        case litll.core.Litll.Arr(array):{
            {
                ...
                var instance = new litll.idl.std.entity.cli.clidl.SubcommandConfig();
