...
class Rgb24LitllToEntity {
    public static function process(context:litll.idl.litll2entity.LitllToEntityContext):litll.core.ds.Result<litll.idl.std.data.util.color.Rgb24, litll.idl.litll2entity.LitllToEntityError> {
