...
class CommandArgumentConfigLitllToEntity {
    public static function process(context:litll.idl.litll2entity.LitllToEntityContext):hxext.ds.Result<litll.idl.std.data.cli.clidl.CommandArgumentConfig, litll.idl.litll2entity.LitllToEntityError> return switch (context.litll) {
