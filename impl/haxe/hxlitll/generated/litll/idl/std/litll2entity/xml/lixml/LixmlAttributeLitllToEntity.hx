...
class LixmlAttributeLitllToEntity {
    ...
    public static function variableInlineProcess(arrayContext:litll.idl.litll2entity.LitllToEntityArrayContext):hxext.ds.Result<litll.idl.std.data.xml.lixml.LixmlAttribute, litll.idl.litll2entity.error.LitllToEntityError> return null;
}