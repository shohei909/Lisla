...
class VariableIntLitllToEntity {
    public static function process(context:litll.idl.litll2entity.LitllToEntityContext, dependenceBitLength:litll.idl.std.data.core.LitllUInt32):hxext.ds.Result<litll.idl.std.data.core.VariableInt, litll.idl.litll2entity.error.LitllToEntityError> {
