...
class LibraryReferenceLitllToEntity {
    ...
    public static function variableInlineProcess(arrayContext:litll.idl.litll2entity.LitllToEntityArrayContext):hxext.ds.Result<litll.idl.std.data.idl.library.LibraryReference, litll.idl.litll2entity.error.LitllToEntityError> return null;
}