...
class LibraryReferenceLitllToEntity {
    public static function process(context:litll.idl.litll2entity.LitllToEntityContext):hxext.ds.Result<litll.idl.std.data.idl.library.LibraryReference, litll.idl.litll2entity.error.LitllToEntityError> {
    ...
    public static function fixedInlineProcess(context:litll.idl.litll2entity.LitllToEntityArrayContext):hxext.ds.Result<litll.idl.std.data.idl.library.LibraryReference, litll.idl.litll2entity.error.LitllToEntityError> return null;
    public static function variableInlineProcess(context:litll.idl.litll2entity.LitllToEntityArrayContext):hxext.ds.Result<litll.idl.std.data.idl.library.LibraryReference, litll.idl.litll2entity.error.LitllToEntityError> return null;
}