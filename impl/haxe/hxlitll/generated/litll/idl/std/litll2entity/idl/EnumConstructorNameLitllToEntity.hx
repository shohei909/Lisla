...
class EnumConstructorNameLitllToEntity {
    public static function process(context:litll.idl.litll2entity.LitllToEntityContext):hxext.ds.Result<litll.idl.std.data.idl.EnumConstructorName, litll.idl.litll2entity.LitllToEntityError> {
