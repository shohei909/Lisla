...
class TypePathLitllToEntity {
    public static function process(context:litll.idl.litll2entity.LitllToEntityContext):hxext.ds.Result<litll.idl.std.data.idl.TypePath, litll.idl.litll2entity.error.LitllToEntityError> {
