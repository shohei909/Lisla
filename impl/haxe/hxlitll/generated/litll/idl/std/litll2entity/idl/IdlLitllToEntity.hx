...
class IdlLitllToEntity {
    public static function process(context:litll.idl.litll2entity.LitllToEntityContext):litll.core.ds.Result<litll.idl.std.data.idl.Idl, litll.idl.litll2entity.LitllToEntityError> {
    ...
    public static function fixedInlineProcess(context:litll.idl.litll2entity.LitllToEntityArrayContext):litll.core.ds.Result<litll.idl.std.data.idl.Idl, litll.idl.litll2entity.LitllToEntityError> return null;
    public static function variableInlineProcess(context:litll.idl.litll2entity.LitllToEntityArrayContext):litll.core.ds.Result<litll.idl.std.data.idl.Idl, litll.idl.litll2entity.LitllToEntityError> return null;
}