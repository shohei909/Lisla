...
class IdlLitllToEntity {
    public static function process(context:litll.idl.litll2entity.LitllToEntityContext):hxext.ds.Result<litll.idl.std.entity.idl.Idl, litll.idl.litll2entity.error.LitllToEntityError> {
        return switch (context.litll) {
            ...
            case litll.core.Litll.Arr(array):{
                ...
                var instance = {
                    ...
                    var instance = new litll.idl.std.entity.idl.Idl(arg0, arg1, arg2);
    ...
    public static function variableInlineProcess(arrayContext:litll.idl.litll2entity.LitllToEntityArrayContext):hxext.ds.Result<litll.idl.std.entity.idl.Idl, litll.idl.litll2entity.error.LitllToEntityError> return null;
}