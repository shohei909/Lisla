        ...
        case litll.core.Litll.Arr(array):{
            {
                ...
                for (litllData in array.data) {
                    ...
                    switch litllData {
                        ...
                        case litll.core.Litll.Arr(array) if (array.length == 2 && array.data[0].match(litll.core.Litll.Str(_.data => "subcommand")) && array.data[1].match(litll.core.Litll.Arr(_))):switch (arg1) {
                            case haxe.ds.Option.Some(_):{
                                return hxext.ds.Result.Err(litll.idl.litll2entity.error.LitllToEntityError.ofLitll(litllData, litll.idl.litll2entity.error.LitllToEntityErrorKind.StructElementDuplicated("subcommand")));
                            };
                            case haxe.ds.Option.None:{
                        ...
                        case litll.core.Litll.Arr(array) if (array.length == 2 && array.data[0].match(litll.core.Litll.Str(_.data => "arg")) && array.data[1].match(litll.core.Litll.Arr(_))):switch (arg2) {
                            case haxe.ds.Option.Some(_):{
                                return hxext.ds.Result.Err(litll.idl.litll2entity.error.LitllToEntityError.ofLitll(litllData, litll.idl.litll2entity.error.LitllToEntityErrorKind.StructElementDuplicated("arg")));
                            };
                            case haxe.ds.Option.None:{
                        ...
                        case litll.core.Litll.Arr(array) if (array.length == 2 && array.data[0].match(litll.core.Litll.Str(_.data => "input")) && array.data[1].match(litll.core.Litll.Arr(_))):switch (arg3) {
                            case haxe.ds.Option.Some(_):{
                                return hxext.ds.Result.Err(litll.idl.litll2entity.error.LitllToEntityError.ofLitll(litllData, litll.idl.litll2entity.error.LitllToEntityErrorKind.StructElementDuplicated("input")));
                            };
                            case haxe.ds.Option.None:{
                ...
                var instance = new litll.idl.std.data.cli.clidl.CommonConfig(arg0, switch (arg1) {
                    ...
                    case haxe.ds.Option.None:{
                        return hxext.ds.Result.Err(litll.idl.litll2entity.error.LitllToEntityError.ofLitll(context.litll, litll.idl.litll2entity.error.LitllToEntityErrorKind.StructElementNotFound("subcommand")));
                    };
                }, switch (arg2) {
                    case haxe.ds.Option.Some(data):{
                        data;
                    ...
                    case haxe.ds.Option.None:{
                        return hxext.ds.Result.Err(litll.idl.litll2entity.error.LitllToEntityError.ofLitll(context.litll, litll.idl.litll2entity.error.LitllToEntityErrorKind.StructElementNotFound("arg")));
                    };
                }, switch (arg3) {
                    case haxe.ds.Option.Some(data):{
                        data;
                    ...
                    case haxe.ds.Option.None:{
                        return hxext.ds.Result.Err(litll.idl.litll2entity.error.LitllToEntityError.ofLitll(context.litll, litll.idl.litll2entity.error.LitllToEntityErrorKind.StructElementNotFound("input")));
                    };
                });
