...
class OptionLitllToEntity {
    public static function process<T>(context:litll.idl.litll2backend.LitllToEntityContext, tLitllToEntity):litll.core.ds.Result<litll.idl.std.data.core.LitllOption<T>, litll.idl.litll2backend.LitllToEntityError> return switch context.litll {
        ...
        case data:litll.core.ds.Result.Err(litll.idl.litll2backend.LitllToEntityError.ofLitll(context.litll, litll.idl.litll2backend.LitllToEntityErrorKind.UnmatchedEnumConstructor(["none", "some"])));
    };
}