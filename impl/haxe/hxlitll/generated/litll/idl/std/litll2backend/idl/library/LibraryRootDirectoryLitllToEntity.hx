...
class LibraryRootDirectoryLitllToEntity {
    public static function process(context:litll.idl.litll2backend.LitllToEntityContext):litll.core.ds.Result<litll.idl.std.data.idl.library.LibraryRootDirectory, litll.idl.litll2backend.LitllToEntityError> return switch context.litll {
        ...
        case data:litll.core.ds.Result.Err(litll.idl.litll2backend.LitllToEntityError.ofLitll(context.litll, litll.idl.litll2backend.LitllToEntityErrorKind.UnmatchedEnumConstructor(["ver", "path"])));
    };
}