...
class SubcommandConfigLitllToBackend {
    public static function process(context:litll.idl.litll2backend.LitllToBackendContext):litll.core.ds.Result<litll.idl.std.data.cli.clidl.SubcommandConfig, litll.idl.litll2backend.LitllToBackendError> return switch (context.litll) {
