...
class IrLitllToEntity {
    public static function process(context:litll.idl.litll2backend.LitllToEntityContext):litll.core.ds.Result<litll.idl.std.data.ir.Ir, litll.idl.litll2backend.LitllToEntityError> return switch context.litll {
        case litll.core.Litll.Arr(array) if (1 <= array.length && array.data[0].match(litll.core.Litll.Str(_.data => "array"))):{
            ...
            var data = {
                ...
                var arg0 = switch (arrayContext.readRest(litll.idl.std.litll2backend.ir.IrLitllToEntity.process, function(data) {
                        return switch data {
        ...
        case litll.core.Litll.Arr(array) if (array.length == 2 && array.data[0].match(litll.core.Litll.Str(_.data => "option")) && array.data[1].match(litll.core.Litll.Arr(_))):{
            ...
            var data = {
                ...
                var arg0 = switch (arrayContext.read(litll.idl.std.litll2backend.core.OptionLitllToEntity.process.bind(_, litll.idl.std.litll2backend.ir.IrLitllToEntity))) {
                    case litll.core.ds.Result.Ok(data):{
                        data;
                    };
                    case litll.core.ds.Result.Err(data):{
        ...
        case litll.core.Litll.Arr(array) if (2 <= array.length && array.data[0].match(litll.core.Litll.Str(_.data => "enum")) && array.data[1].match(litll.core.Litll.Str(_))):{
            ...
            var data = {
                ...
                var arg1 = switch (arrayContext.readRest(litll.idl.std.litll2backend.ir.IrLitllToEntity.process, function(data) {
                        return switch data {
                            case litll.core.Litll.Arr(array) if (1 <= array.length && array.data[0].match(litll.core.Litll.Str(_.data => "array"))):true;
                            case litll.core.Litll.Arr(array) if (array.length == 2 && array.data[0].match(litll.core.Litll.Str(_.data => "option")) && array.data[1].match(litll.core.Litll.Arr(_))):true;
                            case litll.core.Litll.Arr(array) if (2 <= array.length && array.data[0].match(litll.core.Litll.Str(_.data => "enum")) && array.data[1].match(litll.core.Litll.Str(_))):true;
        ...
        case litll.core.Litll.Arr(array) if (1 <= array.length && array.data[0].match(litll.core.Litll.Str(_.data => "struct"))):{
            ...
            var data = {
                ...
                var arg0 = switch (arrayContext.readFixedInline(litll.idl.std.litll2backend.core.MapLitllToEntity.fixedInlineProcess.bind(_, StringLitllToEntity, litll.idl.std.litll2backend.ir.IrLitllToEntity), arrayContext.length - 0)) {
                    case litll.core.ds.Result.Ok(data):{
                        data;
                    };
                    case litll.core.ds.Result.Err(data):{
        ...
        case litll.core.Litll.Arr(array) if (1 <= array.length && array.data[0].match(litll.core.Litll.Str(_.data => "map"))):{
            ...
            var data = {
                ...
                var arg0 = switch (arrayContext.readFixedInline(litll.idl.std.litll2backend.core.MapLitllToEntity.fixedInlineProcess.bind(_, litll.idl.std.litll2backend.ir.PrimitiveIrLitllToEntity, litll.idl.std.litll2backend.ir.IrLitllToEntity), arrayContext.length - 0)) {
                    case litll.core.ds.Result.Ok(data):{
                        data;
                    };
                    case litll.core.ds.Result.Err(data):{
        ...
        case litll.core.Litll.Arr(array) if (array.length == 3 && array.data[0].match(litll.core.Litll.Str(_.data => "fixed_int")) && array.data[1].match(litll.core.Litll.Str(_)) && array.data[2].match(litll.core.Litll.Str(_))):{
            litll.core.ds.Result.Ok(litll.idl.std.data.ir.Ir.Primitive(switch (litll.idl.std.litll2backend.ir.PrimitiveIrLitllToEntity.process(context)) {
                case litll.core.ds.Result.Ok(data):{
                    data;
                };
                case litll.core.ds.Result.Err(data):{
        ...
        case data:litll.core.ds.Result.Err(litll.idl.litll2backend.LitllToEntityError.ofLitll(context.litll, litll.idl.litll2backend.LitllToEntityErrorKind.UnmatchedEnumConstructor(["array", "option", "enum", "tuple", "struct", "map"])));
    };
}