...
class TypeDefinitionDocumentLitllToBackend {
    public static function process(context:litll.idl.litll2backend.LitllToBackendContext):litll.core.ds.Result<litll.idl.std.data.idl.document.TypeDefinitionDocument, litll.idl.litll2backend.LitllToBackendError> return switch (context.litll) {
                ...
                for (litllData in array.data) {
                    ...
                    switch litllData {
                        ...
                        case litll.core.Litll.Arr(array) if (array.length == 2 && array.data[0].match(litll.core.Litll.Str(_.data => "highlight")) && array.data[1].match(litll.core.Litll.Str(_))):arg4.push({
                            var context = new litll.idl.litll2backend.LitllToBackendContext(array.data[1], context.config);
                            switch (litll.idl.std.litll2backend.util.highlight.HighlightScopeLitllToBackend.process(context)) {
                                case litll.core.ds.Result.Ok(data):{
                                    data;
                                };
                                case litll.core.ds.Result.Err(data):{
