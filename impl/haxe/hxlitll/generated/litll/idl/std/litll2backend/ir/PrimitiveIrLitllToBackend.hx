...
class PrimitiveIrLitllToBackend {
    public static function process(context:litll.idl.litll2backend.LitllToBackendContext):litll.core.ds.Result<litll.idl.std.data.ir.PrimitiveIr, litll.idl.litll2backend.LitllToBackendError> return switch context.litll {
        case litll.core.Litll.Arr(array) if (array.length == 3 && array.data[0].match(litll.core.Litll.Str(_.data => "fixed_int")) && array.data[1].match(litll.core.Litll.Str(_)) && array.data[2].match(litll.core.Litll.Str(_))):{
            ...
            var data = {
                ...
                var arg0 = switch (arrayContext.read(litll.idl.std.litll2backend.core.UInt64LitllToBackend.process)) {
                ...
                var arg1 = switch (arrayContext.read(litll.idl.std.litll2backend.core.BigIntLitllToBackend.process)) {
                    case litll.core.ds.Result.Ok(data):{
                        data;
                    };
                    case litll.core.ds.Result.Err(data):{
        ...
        case litll.core.Litll.Arr(array) if (array.length == 3 && array.data[0].match(litll.core.Litll.Str(_.data => "fixed_uint")) && array.data[1].match(litll.core.Litll.Str(_)) && array.data[2].match(litll.core.Litll.Str(_))):{
            ...
            var data = {
                ...
                var arg1 = switch (arrayContext.read(litll.idl.std.litll2backend.core.BigUIntLitllToBackend.process)) {
                    case litll.core.ds.Result.Ok(data):{
                        data;
                    };
                    case litll.core.ds.Result.Err(data):{
        ...
        case litll.core.Litll.Arr(array) if (array.length == 2 && array.data[0].match(litll.core.Litll.Str(_.data => "variable_int")) && array.data[1].match(litll.core.Litll.Str(_))):{
            ...
            var data = {
                ...
                var arg0 = switch (arrayContext.read(litll.idl.std.litll2backend.core.BigIntLitllToBackend.process)) {
                    case litll.core.ds.Result.Ok(data):{
                        data;
                    };
                    case litll.core.ds.Result.Err(data):{
        ...
        case litll.core.Litll.Arr(array) if (array.length == 2 && array.data[0].match(litll.core.Litll.Str(_.data => "variable_uint")) && array.data[1].match(litll.core.Litll.Str(_))):{
            ...
            var data = {
                ...
                var arg0 = switch (arrayContext.read(litll.idl.std.litll2backend.core.BigUIntLitllToBackend.process)) {
                    case litll.core.ds.Result.Ok(data):{
                        data;
                    };
                    case litll.core.ds.Result.Err(data):{
        ...
        case litll.core.Litll.Arr(array) if (array.length == 2 && array.data[0].match(litll.core.Litll.Str(_.data => "float64")) && array.data[1].match(litll.core.Litll.Str(_))):{
            ...
            var data = {
                ...
                var arg0 = switch (arrayContext.read(litll.idl.std.litll2backend.core.Float64LitllToBackend.process)) {
                    case litll.core.ds.Result.Ok(data):{
                        data;
                    };
                    case litll.core.ds.Result.Err(data):{
        ...
        case litll.core.Litll.Arr(array) if (array.length == 2 && array.data[0].match(litll.core.Litll.Str(_.data => "boolean")) && array.data[1].match(litll.core.Litll.Str(_.data => "true")) && array.data[1].match(litll.core.Litll.Str(_.data => "false"))):{
            ...
            var data = {
                ...
                var arg0 = switch (arrayContext.read(litll.idl.std.litll2backend.core.BooleanLitllToBackend.process)) {
                    case litll.core.ds.Result.Ok(data):{
                        data;
                    };
                    case litll.core.ds.Result.Err(data):{
        ...
        case litll.core.Litll.Arr(array) if (array.length == 2 && array.data[0].match(litll.core.Litll.Str(_.data => "binary")) && array.data[1].match(litll.core.Litll.Str(_))):{
            ...
            var data = {
                ...
                var arg0 = switch (arrayContext.read(litll.idl.std.litll2backend.core.BinaryLitllToBackend.process)) {
                    case litll.core.ds.Result.Ok(data):{
                        data;
                    };
                    case litll.core.ds.Result.Err(data):{
        ...
        case data:litll.core.ds.Result.Err(litll.idl.litll2backend.LitllToBackendError.ofLitll(context.litll, litll.idl.litll2backend.LitllToBackendErrorKind.UnmatchedEnumConstructor(["fixed_int", "fixed_uint", "variable_int", "variable_uint", "float64", "boolean", "string", "binary"])));
    };
}