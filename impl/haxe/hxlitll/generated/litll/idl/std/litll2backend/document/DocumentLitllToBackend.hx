...
class DocumentLitllToBackend {
    public static function process(context:litll.idl.litll2backend.LitllToBackendContext):litll.core.ds.Result<litll.idl.std.data.document.Document, litll.idl.litll2backend.LitllToBackendError> return switch (context.litll) {
        ...
        case litll.core.Litll.Arr(array):{
            {
                    ...
                    switch litllData {
                        case litll.core.Litll.Arr(array) if (array.length == 2 && array.data[0].match(litll.core.Litll.Str(_.data => "comment")) && array.data[1].match(litll.core.Litll.Str(_))):switch (arg0) {
                            case haxe.ds.Option.Some(_):{
                                return litll.core.ds.Result.Err(litll.idl.litll2backend.LitllToBackendError.ofLitll(litllData, litll.idl.litll2backend.LitllToBackendErrorKind.StructElementDuplicated("comment")));
                            };
                ...
                var instance = new litll.idl.std.data.document.Document(switch (arg0) {
                    ...
                    case haxe.ds.Option.None:{
                        return litll.core.ds.Result.Err(litll.idl.litll2backend.LitllToBackendError.ofLitll(context.litll, litll.idl.litll2backend.LitllToBackendErrorKind.StructElementNotFound("comment")));
                    };
                });
