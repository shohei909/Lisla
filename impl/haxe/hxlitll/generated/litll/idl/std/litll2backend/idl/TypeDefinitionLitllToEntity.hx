...
class TypeDefinitionLitllToEntity {
    public static function process(context:litll.idl.litll2backend.LitllToEntityContext):litll.core.ds.Result<litll.idl.std.data.idl.TypeDefinition, litll.idl.litll2backend.LitllToEntityError> return switch context.litll {
        case litll.core.Litll.Arr(array) if (array.length == 3 && array.data[0].match(litll.core.Litll.Str(_.data => "newtype"))):{
            ...
            var data = {
                ...
                var arg0 = switch (arrayContext.read(litll.idl.std.litll2backend.idl.TypeNameDeclarationLitllToEntity.process)) {
        ...
        case litll.core.Litll.Arr(array) if (2 <= array.length && array.data[0].match(litll.core.Litll.Str(_.data => "enum"))):{
            ...
            var data = {
                ...
                var arg1 = switch (arrayContext.readRest(litll.idl.std.litll2backend.idl.EnumConstructorLitllToEntity.process, function(data) {
                        return switch data {
                            case litll.core.Litll.Str(_):true;
        ...
        case litll.core.Litll.Arr(array) if (2 <= array.length && array.data[0].match(litll.core.Litll.Str(_.data => "struct"))):{
            ...
            var data = {
                ...
                var arg1 = switch (arrayContext.readRest(litll.idl.std.litll2backend.idl.StructElementLitllToEntity.process, function(data) {
                        return switch data {
                            case litll.core.Litll.Str(_):true;
        ...
        case data:litll.core.ds.Result.Err(litll.idl.litll2backend.LitllToEntityError.ofLitll(context.litll, litll.idl.litll2backend.LitllToEntityErrorKind.UnmatchedEnumConstructor(["newtype", "tuple", "enum", "struct"])));
    };
}