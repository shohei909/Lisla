...
class DateTimeLitllToEntity {
    public static function process(context:litll.idl.litll2backend.LitllToEntityContext):litll.core.ds.Result<litll.idl.std.data.core.LitllDateTime, litll.idl.litll2backend.LitllToEntityError> {
