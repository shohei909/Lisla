...
class BitllToEntityDeclarationLitllToEntity {
    public static function process(context:litll.idl.litll2entity.LitllToEntityContext):hxext.ds.Result<litll.idl.hxlitll.data.config.BitllToEntityDeclaration, litll.idl.litll2entity.error.LitllToEntityError> return switch context.litll {
        case litll.core.Litll.Arr(array) if (1 <= array.length && array.data[0].match(litll.core.Litll.Str(_.data => "bitll_to_entity"))):{
            ...
            var data = {
                ...
                hxext.ds.Result.Ok(litll.idl.hxlitll.data.config.BitllToEntityDeclaration.BitllToEntity(arg0));
            };
        ...
        case litll.core.Litll.Arr(array) if (array.length == 1 && array.data[0].match(litll.core.Litll.Str(_.data => "no_bitll_to_entity"))):{
            var arrayContext = new litll.idl.litll2entity.LitllToEntityArrayContext(array, 0, context.config);
            var data = hxext.ds.Result.Ok(litll.idl.hxlitll.data.config.BitllToEntityDeclaration.NoBitllToEntity);
            switch (arrayContext.closeOrError()) {
                case haxe.ds.Option.None:{
                    data;
                };
