...
class EntityToBitllDeclarationLitllToEntity {
    public static function process(context:litll.idl.litll2entity.LitllToEntityContext):hxext.ds.Result<litll.idl.hxlitll.entity.config.EntityToBitllDeclaration, litll.idl.litll2entity.error.LitllToEntityError> return switch context.litll {
        case litll.core.Litll.Arr(array) if (1 <= array.length && array.data[0].match(litll.core.Litll.Str(_.data => "entity_to_bitll"))):{
            ...
            var data = {
                ...
                var arg0 = switch (arrayContext.readFixedInline(litll.idl.hxlitll.litll2entity.config.EntityToBitllConfigLitllToEntity.process, arrayContext.length - 0)) {
                ...
                hxext.ds.Result.Ok(litll.idl.hxlitll.entity.config.EntityToBitllDeclaration.EntityToBitll(arg0));
            };
        ...
        case litll.core.Litll.Arr(array) if (array.length == 1 && array.data[0].match(litll.core.Litll.Str(_.data => "no_entity_to_bitll"))):{
            var arrayContext = new litll.idl.litll2entity.LitllToEntityArrayContext(array, 0, context.config);
            var data = hxext.ds.Result.Ok(litll.idl.hxlitll.entity.config.EntityToBitllDeclaration.NoEntityToBitll);
            switch (arrayContext.closeOrError()) {
                case haxe.ds.Option.None:{
                    data;
                };
