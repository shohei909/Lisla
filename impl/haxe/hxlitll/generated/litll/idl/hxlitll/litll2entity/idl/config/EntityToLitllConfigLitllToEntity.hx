...
class EntityToLitllConfigLitllToEntity {
    public static function process(context:litll.idl.litll2entity.LitllToEntityContext):hxext.ds.Result<litll.idl.hxlitll.data.idl.config.EntityToLitllConfig, litll.idl.litll2entity.LitllToEntityError> return switch (context.litll) {
        ...
        case litll.core.Litll.Arr(array):{
            {
                ...
                var instance = new litll.idl.hxlitll.data.idl.config.EntityToLitllConfig(switch (arg0) {
