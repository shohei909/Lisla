...
class LislaToEntityConfigLislaToEntity {
    public static function process(context:lisla.idl.lisla2entity.LislaToEntityContext):hxext.ds.Result<lisla.idl.hxlisla.entity.config.LislaToEntityConfig, lisla.idl.lisla2entity.error.LislaToEntityError> return switch (context.lisla) {
        ...
        case lisla.core.Lisla.Arr(array):{
            {
                ...
                var instance = new lisla.idl.hxlisla.entity.config.LislaToEntityConfig(arg0);
                hxext.ds.Result.Ok(instance);
            };
        };
    };
    public static function variableInlineProcess(arrayContext:lisla.idl.lisla2entity.LislaToEntityArrayContext):hxext.ds.Result<lisla.idl.hxlisla.entity.config.LislaToEntityConfig, lisla.idl.lisla2entity.error.LislaToEntityError> return null;
}