...
class LitllToEntityConfigLitllToEntity {
    public static function process(context:litll.idl.litll2entity.LitllToEntityContext):hxext.ds.Result<litll.idl.hxlitll.entity.config.LitllToEntityConfig, litll.idl.litll2entity.error.LitllToEntityError> return switch (context.litll) {
        ...
        case litll.core.Litll.Arr(array):{
            {
                ...
                var instance = new litll.idl.hxlitll.entity.config.LitllToEntityConfig(arg0);
                hxext.ds.Result.Ok(instance);
            };
        };
    };
    public static function variableInlineProcess(arrayContext:litll.idl.litll2entity.LitllToEntityArrayContext):hxext.ds.Result<litll.idl.hxlitll.entity.config.LitllToEntityConfig, litll.idl.litll2entity.error.LitllToEntityError> return null;
}