...
class FilterDeclarationLitllToEntity {
    ...
    public static function variableInlineProcess(arrayContext:litll.idl.litll2entity.LitllToEntityArrayContext):hxext.ds.Result<litll.idl.hxlitll.data.config.FilterDeclaration, litll.idl.litll2entity.error.LitllToEntityError> return null;
}