...
class EntityToLitllDeclarationLitllToEntity {
    public static function process(context:litll.idl.litll2entity.LitllToEntityContext):hxext.ds.Result<litll.idl.hxlitll.data.idl.config.EntityToLitllDeclaration, litll.idl.litll2entity.LitllToEntityError> return switch context.litll {
