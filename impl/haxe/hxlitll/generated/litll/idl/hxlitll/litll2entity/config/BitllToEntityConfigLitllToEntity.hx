...
class BitllToEntityConfigLitllToEntity {
    public static function process(context:litll.idl.litll2entity.LitllToEntityContext):hxext.ds.Result<litll.idl.hxlitll.data.config.BitllToEntityConfig, litll.idl.litll2entity.error.LitllToEntityError> return switch (context.litll) {
        ...
        case litll.core.Litll.Arr(array):{
            {
                ...
                var instance = new litll.idl.hxlitll.data.config.BitllToEntityConfig(arg0);
                hxext.ds.Result.Ok(instance);
            };
        };
    };
    public static function fixedInlineProcess(context:litll.idl.litll2entity.LitllToEntityArrayContext):hxext.ds.Result<litll.idl.hxlitll.data.config.BitllToEntityConfig, litll.idl.litll2entity.error.LitllToEntityError> return null;
    public static function variableInlineProcess(context:litll.idl.litll2entity.LitllToEntityArrayContext):hxext.ds.Result<litll.idl.hxlitll.data.config.BitllToEntityConfig, litll.idl.litll2entity.error.LitllToEntityError> return null;
}