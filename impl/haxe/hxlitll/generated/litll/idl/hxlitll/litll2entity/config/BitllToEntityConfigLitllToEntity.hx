...
class BitllToEntityConfigLitllToEntity {
    ...
    public static function variableInlineProcess(arrayContext:litll.idl.litll2entity.LitllToEntityArrayContext):hxext.ds.Result<litll.idl.hxlitll.data.config.BitllToEntityConfig, litll.idl.litll2entity.error.LitllToEntityError> return null;
}