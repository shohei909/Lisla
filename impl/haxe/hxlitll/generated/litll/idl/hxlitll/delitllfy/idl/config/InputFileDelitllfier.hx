...
class InputFileDelitllfier {
    public static function process(context:litll.idl.delitllfy.DelitllfyContext):litll.core.ds.Result<litll.idl.hxlitll.data.idl.config.InputFile, litll.idl.delitllfy.DelitllfyError> return switch (context.litll) {
