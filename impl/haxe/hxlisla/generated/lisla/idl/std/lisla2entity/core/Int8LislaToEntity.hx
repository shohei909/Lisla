...
class Int8LislaToEntity {
    public static function process(context:lisla.idl.lisla2entity.LislaToEntityContext):hxext.ds.Result<lisla.idl.std.entity.core.LislaInt8, lisla.idl.lisla2entity.error.LislaToEntityError> {
