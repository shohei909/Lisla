...
class DirectoryPathLislaToEntity {
    public static function process(context:lisla.idl.lisla2entity.LislaToEntityContext):hxext.ds.Result<lisla.idl.std.entity.util.file.DirectoryPath, lisla.idl.lisla2entity.error.LislaToEntityError> {
