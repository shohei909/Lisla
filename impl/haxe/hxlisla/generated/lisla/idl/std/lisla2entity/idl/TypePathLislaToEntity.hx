...
class TypePathLislaToEntity {
    public static function process(context:lisla.idl.lisla2entity.LislaToEntityContext):hxext.ds.Result<lisla.idl.std.entity.idl.TypePath, lisla.idl.lisla2entity.error.LislaToEntityError> {
