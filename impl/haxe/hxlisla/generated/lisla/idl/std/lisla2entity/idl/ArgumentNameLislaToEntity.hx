...
class ArgumentNameLislaToEntity {
    public static function process(context:lisla.idl.lisla2entity.LislaToEntityContext):hxext.ds.Result<lisla.idl.std.entity.idl.ArgumentName, lisla.idl.lisla2entity.error.LislaToEntityError> {
