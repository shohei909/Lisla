...
class GenerationConfigLislaToEntity {
    public static function process(context:lisla.idl.lisla2entity.LislaToEntityContext):hxext.ds.Result<lisla.idl.hxlisla.entity.config.GenerationConfig, lisla.idl.lisla2entity.error.LislaToEntityError> return switch (context.lisla) {
        ...
        case lisla.core.Lisla.Arr(array):{
            {
                ...
                var instance = new lisla.idl.hxlisla.entity.config.GenerationConfig(switch (arg0) {
