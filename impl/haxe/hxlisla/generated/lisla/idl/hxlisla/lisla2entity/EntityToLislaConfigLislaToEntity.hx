...
class EntityToLislaConfigLislaToEntity {
    public static function process(context:lisla.idl.lisla2entity.LislaToEntityContext):hxext.ds.Result<lisla.idl.hxlisla.entity.EntityToLislaConfig, lisla.idl.lisla2entity.error.LislaToEntityError> return switch (context.lisla) {
